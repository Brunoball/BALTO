...
// BALTO_SERVICIOS ya no posee login local.
...
// Este smoke verifica que Servicios acepte esa sesión y permita entrar al panel.
test('@smoke sesión global válida permite entrar a Servicios', async ({ page }) => {
  ...
  // Servicios no debe volver a mostrar ni solicitar sus credenciales locales.
